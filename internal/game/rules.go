...
type GameRules struct {
	...
	// HandRankings lists the poker hands that are valid in this game, ordered from strongest to weakest.
	HandRankings struct {
	...
	// LowHand defines the rules for the low hand portion of the game (for Hi-Lo variants).
	LowHand struct {
